...
public class Menu_Commands
{
    ...
    //public void CollectNew(Context context, OpMode opMode)
    public void CollectNew()//OpMode opMode)
    {
        ...
        if (configStepState == currConfigStepCheck)
        {
            ...
            if (y1 && !lastY1)
            {
                param.colorAlliance = param.colorAlliance.next();
            }
            if (a1 && !lastA1)
            {
